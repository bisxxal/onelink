...
function Chat({data}) {
  ...
  return (
    <div className=' w-full p-2 max-xl:px-1 fle  justify-center text-xs bg-[#16161E] rounded-3xl'>
      <h1 className=" text-center text-lg my-2">Viwes</h1>
                             
    <ResponsiveContainer width="100%" height={200}>
        <LineChart width={730} height={250} data={dataWithoutGaps}
                   margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid horizontal={false} strokeWidth="1" stroke="#f5f5f5" />
          ...
          <Tooltip />
          <Line
            type="monotone" dataKey={xLabelKey} stroke="#09f" strokeWidth="3" />
        </LineChart>
      </ResponsiveContainer>
